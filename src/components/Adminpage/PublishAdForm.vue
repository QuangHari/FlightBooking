      ...
      <div class="max-w-3xl mx-auto bg-white rounded-3xl shadow-2xl">
        <div class="p-8">
          ...
          <form @submit.prevent="handleSubmit" class="space-y-6">
            <!-- Card Title -->
            <div class="space-y-1">
              <label class="text-sm text-gray-500">Card Title</label>
              <input 
            ...
            <!-- Description -->
            <div class="space-y-1">
              <label class="text-sm text-gray-500">Card Subtitle</label>
              <input 
            ...
            <!-- Image -->
            <div class="space-y-1">
              <label class="text-sm text-gray-500">Upload Image</label>
              <input 
          ...
          >
            <div class="bg-white p-6 rounded-lg shadow-xl">
              <div class="text-center">
                ...
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Plane Card Successfully</h3>
                <p class="text-gray-600 mb-4">The card has been added to the database.</p>
                <button
